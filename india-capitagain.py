...
fig.add_trace(go.Scatter(
    ...
    textposition=["top left" if x == intersection_selling_price else "bottom center" for x in selling_prices],
    textfont=dict(size=16, color='black', family='Arial, bold')  # Bold and double size
))
fig.add_trace(go.Scatter(
